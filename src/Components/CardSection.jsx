              ...
              elem.type === 3 ? (
                ...
                >
                  ...
                  >
                    ...
                    <div className="card__face back special_card2" style={{opacity:"0.7"}}>
                      <div className="card_sign">
          ...
          <div action="#">
            <select className="form-select" onChange={(e) => {
              ...
              {stockExchangeDetails.map((company) => (
                <option value={company.company_ticker}>{company.company_name}</option>
              ))}
            </select>
          </div>
          {el.type===3?
